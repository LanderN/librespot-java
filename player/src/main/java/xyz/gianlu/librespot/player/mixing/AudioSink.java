...
public final class AudioSink implements Runnable, Closeable {
    ...
    private static class Output implements Closeable {
        ...
        Output(@NotNull Type type, @NotNull MixingLine mixing, @NotNull PlayerConfiguration conf, @Nullable File pipe, @Nullable OutputStream out, @Nullable String gstSink) {
            this.conf = conf;
            this.mixing = mixing;
            this.type = type;
            this.pipe = pipe;
